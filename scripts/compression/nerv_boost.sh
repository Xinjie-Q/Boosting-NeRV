...
do
python train_nerv_compression.py --outf compression/NeRV_Boost/target4 --model NeRV_Boost --sft_block res_sft --ch_t 32 \
   ...
   --weight ./output/regression/NeRV_Boost/epoch_300/$video/Size$size/model_latest.pth \
